...
// Read: magic word + fpga version (32 bits access)
...
{
	static const char *fw_files[][5] = {
	    /*  xilinx 1      xilinx 2          eeprom           boot              dsp           */
	[0] = { "xlxint.dat", "xlxc882hr.dat",  "dspe882.e56",   "dspb882hr.b56",  "dspd882.d56" },
	[1] = { "xlxint.dat", "xlxc882e.dat",   "dspe882.e56",   "dspb882e.b56",   "dspd882.d56" },
	[2] = { "xlxint.dat", "xlxc1222hr.dat", "dspe882.e56",   "dspb1222hr.b56", "dspd1222.d56" },
	[3] = { "xlxint.dat", "xlxc1222e.dat",  "dspe882.e56",   "dspb1222e.b56",  "dspd1222.d56" },
	[4] = { NULL,         "xlxc222.dat",    "dspe924.e56",   "dspb924.b56",    "dspd222.d56" },
	[5] = { NULL,         "xlxc924.dat",    "dspe924.e56",   "dspb924.b56",    "dspd222.d56" },
	[6] = { NULL,         NULL,             "dspe924e5.e56", "dspb924.b56",    "dspd222.d56" },
	[7] = { NULL,         NULL,             "dspe924e5.e56", "dspb924.b56",    "dspd222.d56" },
	};
	char path[32];
	...
	get_xilinx_version(mgr);

	for (i = 0; i < 5; i++) {
		if (!fw_files[fw_set][i]) {
			if( ((fw_set == 6) ||(fw_set == 7)) && (i==1)) {
				pcxhr_reset_xilinx_com(mgr);
				mdelay(1000);
			}
			continue;
...
MODULE_FIRMWARE("pcxhr/dspe924e5.e56");
